package com.giodad.lil.roomwebapp.config;

import com.giodad.lil.roomwebapp.async.RoomCleanerListener;
...
public class AsyncConfig {
    ...
    @Bean
    public MessageListenerAdapter adapter(RoomCleanerListener listener) {
